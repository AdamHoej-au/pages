...
pole_zero_plot <- function(x_zero_, y_zero_, x_pole_, y_pole_, range,expr = 1/s, exprrange = 5) {
...
## Step plot
  plot(stepLi,type="l", col="Red", xlim = c(-0.25, exprrange), panel.first = grid(),
  xlab = "t [s]", ylab = "f(t)",
  main="Stepresponse")
  abline(v = 0, h = 0,lty=2)
 ## Puls plot 
  plot(pulseLi,type="l", col="Blue", xlim = c(-0.25, exprrange), panel.first = grid(),
  xlab = "t [s]", ylab = "f(t)",
...
## Opgaver fra forelæsning  {.tabset .tabset-fade .tabset-pills} 

### Opgave 1 {.tabset .tabset-fade .tabset-pills} 

```{r child = 'nise/opg1.Rmd'}
```

# {.tabset .tabset-fade .tabset-pills} 

## Opgave fra Nise pdf {.tabset .tabset-fade .tabset-pills} 

```{r child = 'nise/ex-4-3.Rmd'}
```
