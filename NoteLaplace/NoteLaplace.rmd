...
pole_zero_plot <- function(x_zero_, y_zero_, x_pole_, y_pole_, range,expr, exprrange = 10) {
...
minMax <- c(-range,range)
  ...
  plot(stepLi,type="l", col="Red", xlim = c(-1, exprrange), panel.first = grid(),
  xlab = "t [s]", ylab = "f(t)",
  main="Stepresponse")
  abline(v = 0, h = 0,lty=2)
  plot(pulseLi,type="l", col="Blue", xlim = c(-1, exprrange), panel.first = grid(),
  xlab = "t [s]", ylab = "f(t)",
...
pole_zero_plot(x_zero, y_zero, x_pole, y_pole,10,expr)
```
## Opgave 6 {.tabset .tabset-fade}

### Opgave A

```{r child = 'opg6/opgaveA.Rmd'}
```

### Opgave B

```{r child = 'opg6/opgaveB.Rmd'}
```

### Opgave C

```{r child = 'opg6/opgaveC.Rmd'}
```
